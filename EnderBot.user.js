...
function getLatestCommit() {
 ...
 $.get('http://github.com/Enderbel/EnderBot/raw/master/EnderBot.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
...
setTimeout(function() {
   ...
   socket.on('spawn-count', function(data) {
    ...
    if (client_id == null) {
        ...
        client_id = ""; var ranStr = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789";
        for (var ii = 0; ii < 15; ii++) client_id += ranStr.charAt(Math.floor(Math.random() * ranStr.length));
