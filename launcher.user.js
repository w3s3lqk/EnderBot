...
// ==UserScript==
// @name        EnderLauncher
// @namespace   EnderLauncher
// @include     http://agar.io/*
// @version     1.7
// @grant       none
// @author      EnderBel Skype:ytrioq
// ==/UserScript==
var EnderLauncherLauncherVersion = 1.7;
    ...
    window.jQuery.ajax({
        ...
        function update(prefix, name, url) {
            window.jQuery(document.body).prepend("<div id='" + prefix + "Dialog' style='position: absolute; left: 0px; right: 0px; top: 0px; bottom: 0px; z-index: 100; display: none;'>");
                window.jQuery('#' + prefix + 'Dialog').append("<div id='" + prefix + "Message' style='width: 1000px; background-color: #FFFFFF; margin: 100px auto; border-radius: 15px; padding: 5px 15px 5px 15px;'>");
                window.jQuery('#' + prefix + 'Message').append("<h2>                           Требуется обновление Бота!!!</h2>");
                window.jQuery('#' + prefix + 'Message').append("<p>                                                                                    Скачайте обновление: <a id='" + prefix + "Link' href='" + url + "' target=\"_blank\">" + name + "</a></p>");
                window.jQuery('#' + prefix + 'Message').append("<p>                                                                                                <a id='" + prefix + "Link' href='" + url + "' target=\"_blank\">" + name + "</a></p>");
                window.jQuery('#' + prefix + 'Message').append("<p>                                                                                                <a id='" + prefix + "Link' href='" + url + "' target=\"_blank\">" + name + "</a></p>");
                window.jQuery('#' + prefix + 'Message').append("<p>                                                                                                <a id='" + prefix + "Link' href='" + url + "' target=\"_blank\">" + name + "</a></p>");
                window.jQuery('#' + prefix + 'Message').append("<p>                                                                                                <a id='" + prefix + "Link' href='" + url + "' target=\"_blank\">" + name + "</a></p>");
                window.jQuery('#' + prefix + 'Message').append("<p>                                                                                                <a id='" + prefix + "Link' href='" + url + "' target=\"_blank\">" + name + "</a></p>");
        ...
        window.jQuery.get('https://raw.githubusercontent.com/EnderBel/EnderBot/master/launcher.user.js?' + Math.floor((Math.random() * 1000000) + 1), function(data) {
            ...
            var myVersion = parseFloat(EnderLauncherLauncherVersion + 0.0000);

            if (latestVersion > myVersion) {
                update("EnderLauncherLauncher", "launcher.user.js", "https://github.com/EnderBel/EnderBot/blob/" + sha + "/launcher.user.js/");
            }
...
function addAd() {
    ...
    window.jQuery(".side-container:last").append("<div class='agario-panel'><center id='EnderLauncherAd'></center></div>");
    var EnderLauncherAd = document.getElementById('EnderLauncherAd');
    var w = document.write;
    document.write = function (content) {
        EnderLauncherAd.innerHTML = content;
        document.write = w;
    };
...
})(window, document, 'script', '//www.google-analytics.com/analytics.js', 'EnderLauncher');

EnderLauncher('create', 'UA-64394184-1', 'auto');
EnderLauncher('send', 'pageview');
